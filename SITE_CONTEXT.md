...
## Articles system
- 18 articles in `content/articles/[slug]/index.mdx` (newest: project-sub-three 2026-07-15, hoop-rhythm 2026-07-14, looks-like-prototype 2026-07-13, one-sensor-two-prototypes 2026-07-12); frontmatter: title, date, category, description, coverImage, gradient, readTime, `animatedCover` ("electric-bolt"), `customHref` (card links elsewhere, e.g. a playground page — detail route redirects)
