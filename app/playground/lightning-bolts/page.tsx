...
// ─────────────────────────────────────────────────────────────────────────────
// Lightning Bolts — motion graphics lab by Steve Black
// Lives at /playground/lightning-bolts
//
// The site's logo mark (Lucide zap path) explored through AI-driven motion:
// animation personalities, section dividers, and LinkedIn brand assets.
// Moved here from inline sections on /playground (July 2026).
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────
// Lightning Bolts Page
// ─────────────────────────────────────────────
export default function LightningBoltsPage() {
  ...
  return (
    <div className="bg-[#0a0a0a] min-h-screen pt-16">
      ...
      <section className="px-6 pt-20 pb-16 max-w-6xl mx-auto">
        <Link
          href="/playground"
          className="group inline-flex items-center gap-1.5 text-xs tracking-widest uppercase text-[#555555] hover:text-[#d4a853] transition-colors mb-10"
        >
        ...
        <div>
          ...
          <p className="text-lg md:text-xl text-[#888888] font-light leading-relaxed max-w-xl">
            Some fun using AI to drive motion graphics. The site&apos;s logo mark —
            one simple SVG path — explored through animation personalities, section
            dividers, and brand assets. Every motion here started as a prompt.
          </p>
        </div>
      ...
      {/* ── Experiment 01: Lightning Bolt Animations ─────────────────── */}
      ...
      <section className="px-6 pb-32 max-w-6xl mx-auto">
        <div className="pt-8 border-t border-[#1a1a1a] flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-[#555555] font-light">
          <p>Built by Steve Black with Claude — every animation started as a prompt.</p>
          <Link
            href="/playground"
            className="group inline-flex items-center gap-1.5 hover:text-[#d4a853] transition-colors"
          >
            <span className="transition-transform group-hover:-translate-x-0.5">←</span>
            Back to Playground
          </Link>
