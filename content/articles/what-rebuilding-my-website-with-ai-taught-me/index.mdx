...
For years it lived on website builders — Bluehost, then Squarespace. Pick a template, set a theme, drop in blog posts. It worked. But the ceiling was always the template.

I wanted to see how far I could actually take it — and stay hands-on with what these AI tools can really do.
...
## The workflow is a product too

More than a year in, the way I build this site has gone through its own versions.

v1 was Claude Code inside Cursor — an engineer's cockpit. Powerful, but I spent my time in the code.

v2 is where I work now: a Cowork project with full context on the site. I talk through the problem, Claude writes the code straight into the repo, and I review the result live before anything ships. I stay in the conversation; the code stays out of my way.

Same loop I preach everywhere else: ship, look at it, learn, adjust. Applied to the workflow itself.

And the site has become the testbed — every prototype, experiment, and article lands here first. That's what the [Playground](/playground) is for.
