...
*Prefer to watch? [The video version is on YouTube →](https://www.youtube.com/watch?v=XRmGmVXChPE)*
...
<div style={{position: 'relative', width: '100%', paddingBottom: '56.25%', marginTop: '2rem', marginBottom: '1rem', borderRadius: '12px', overflow: 'hidden'}}>
  <iframe
    src="https://www.youtube.com/embed/XRmGmVXChPE"
    title="Is AI the New Drum Kit? — Steve Black"
