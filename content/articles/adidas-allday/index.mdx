...
AllDay was Adidas's attempt to do what Nike had done with NTC — build a first-party fitness app that extended the brand into the daily life of the consumer. But where Nike anchored on performance, AllDay was Adidas's way into health and wellness — a product meant to matter in someone's everyday habits, not just their workouts.

I was there from the first pitch. I helped frame the concept and carried it from the ground up through launch as Lead PM — this wasn't a working app I inherited, it was one I helped build from scratch. The challenge was turning casual users into subscribers.
...
## Active minutes and the N-of-1 experiment

The idea we built AllDay around was active minutes — a simple, honest signal of whether something was actually earning a place in your day.

On top of that signal, we designed small self-experiments: short, low-stakes trials a user could run to see whether a habit actually fit their life. Every experiment we recommended was grounded in real science — we only put forward things that were genuinely good for you. But the product's real bet was that "good for you" isn't enough. A habit also has to fit. So each experiment let the user weigh it honestly — the effort, how it moved their active minutes, and whether they simply liked it. You might watch Brussels sprouts move a real number and still decide they're not for you. That was a valid result.

That was the part I'm proudest of: N-of-1. You, as your own study. Grounded in real science, but pointed at the one question a population-level study can never answer — what actually works for you, found in small, testable pieces.
